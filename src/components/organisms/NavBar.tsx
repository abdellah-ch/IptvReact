...
const NavBar = () => {
  ...
  return (
      <div className="flex justify-between  h-[87px] sticky top-0 bg-black max-w-[91%] lg:flex lg:max-w-[90%] lg:m-auto lg:items-center lg:justify-around">
        ...
        {/* Desktop links */}
           <div className="hidden lg:flex lg:flex-row lg:justify-center lg:items-center  gap-16">
          <div className="py-5  hover:text-primary hover:border-b-[3px]  hover:border-b-primary  transition-all duration-300 ease-in-out text-[1em] font-semibold tracking-wide">
            <a href="#" >Home</a>
          </div>
          <div className="py-5  hover:text-primary hover:border-b-[3px]  hover:border-b-primary  transition-all duration-300 ease-in-out text-[1em] font-semibold tracking-wide">
            <a href="#" >Pricing</a>
        ...
        {/* Mobile Nav */} 
         <div className={isOpen ? "fixed h-screen w-screen bg-black translate-y-0 duration-700 top-0" : "fixed -top-[100%] - h-screen w-screen -translate-y-full duration-700"}>
        ...
        <div className="hidden md:flex md:mt-auto md:mb-auto md:cursor-pointer">
          <Button className="font-bold purchaseButton">PURCHASE</Button>
        </div>
      </div>
  );
};
