...
const Checkout = () => {
    return (
        <div className="lg:h-[84vh] flex justify-center items-center text-black">
            ...
            <div className="grid sm:px-10 lg:grid-cols-2 lg:px-20 xl:px-32">
                ...
                <div className="mt-10 bg-black px-4 pt-8 lg:mt-0">
                    ...
                    <div className="">
                        ...
                        <label htmlFor="card-holder" className="mt-4 mb-2 block text-sm font-medium text-white">Card Holder</label>
                        <div className="relative">
                        ...
                        <label htmlFor="card-no" className="mt-4 mb-2 block text-sm font-medium text-white">Card Details</label>
                        <div className="flex">
                    ...
                    <button className="mt-4 mb-8 w-full rounded-md bg-primary px-6 py-3 font-medium text-white">Place Order</button>
                </div>
            </div>
        </div>
